...
export default function OwnerTopbar() {
  ...
  const goToProfile = () => setProfileOpen(false);
  const handleLogout = () => setProfileOpen(false);

  const [notifications, setNotifications] = useState([
    {
      id: 1,
      title: topbarT.notifNewOrder || "New order received — #FQ-8841",
    ...
    {
      id: 2,
      title: topbarT.notifNewReview || "New 5-star review submitted",
    ...
    {
      id: 3,
      title: topbarT.notifOrderCancelled || "Order #FQ-8836 was cancelled",
  ...
  return (
    <header className="h-20 bg-white/80 dark:bg-[#1A1310]/80 backdrop-blur-md border-b border-orange-100 dark:border-orange-900/30 px-8 flex items-center justify-between sticky top-0 z-30 transition-colors duration-300">
      <div className="flex items-center gap-3 w-96 bg-orange-50/50 dark:bg-white/5 border border-orange-200 dark:border-orange-900/40 rounded-xl px-4 py-2.5">
        ...
        <input
          type="text"
          placeholder={topbarT.searchPlaceholder || "Search menu items, orders..."}
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative border-l border-orange-100 dark:border-orange-900/30 pl-4">
          ...
          >
            ...
            <div>
              <h4 className="text-sm font-bold text-[#1A1310] dark:text-white">{user.name}</h4>
              <p className="text-[11px] text-orange-600 dark:text-orange-400 font-semibold">{topbarT.restaurantOwner || "Restaurant Owner"}</p>
            </div>
          </button>
          {profileOpen && (
            <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-[#241C17] border border-orange-100 dark:border-orange-900/30 rounded-xl shadow-lg overflow-hidden z-50">
              ...
              >
                ...
                {topbarT.myRestaurantProfile || "My Restaurant Profile"}
              </button>
              <button
