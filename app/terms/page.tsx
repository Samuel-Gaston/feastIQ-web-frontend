        ...
        <div className="space-y-6 text-sm sm:text-base leading-relaxed text-gray-700 dark:text-white/80">
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#1A1310] dark:text-white">
              {t.terms?.sec1Title || "1. Acceptance of Terms"}
            </h2>
            <p>{t.terms?.sec1Text || "Welcome to FeastIQ..."}</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#1A1310] dark:text-white">
              {t.terms?.sec2Title || "2. Description of Service"}
            </h2>
            <p>{t.terms?.sec2Text || "FeastIQ is a technology platform..."}</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#1A1310] dark:text-white">
              {t.terms?.sec3Title || "3. User Accounts and Security"}
            </h2>
            <p>{t.terms?.sec3Text || "You must register with accurate information..."}</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#1A1310] dark:text-white">
              {t.terms?.sec4Title || "4. Orders and Payments"}
            </h2>
            <p>{t.terms?.sec4Text || "All orders placed on FeastIQ..."}</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#1A1310] dark:text-white">
              {t.terms?.sec5Title || "5. AI Usage and Recommendations"}
            </h2>
            <p>{t.terms?.sec5Text || "Our artificial intelligence features..."}</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#1A1310] dark:text-white">
              {t.terms?.sec6Title || "6. Limitation of Liability"}
            </h2>
            <p>{t.terms?.sec6Text || "FeastIQ acts as a technology intermediary..."}</p>
          </section>
        </div>
      </main>
